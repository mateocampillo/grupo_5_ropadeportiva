...
CREATE TABLE `facturas` (
  ...
  `id_productos` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_FAC_USE` (`id_cliente`),
  CONSTRAINT `FK_FAC_USE` FOREIGN KEY (`id_cliente`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-08-01 21:40:55
